...
declare const startListen: (
  roomId: number,
  handler: MsgHandler,
  options?: MessageListenerTCPOptions,
) => MessageListener;

export {
  type AnchorLotteryEndMsg,
  type AnchorLotteryStartMsg,
  type AttentionChangeMsg,
  type DanmuMsg,
  type GiftMsg,
  type GuardBuyMsg,
  GuardLevel,
  ...
  type MsgHandler,
  type RankCountChangeMsg,
  type RedPocketEndMsg,
  type RedPocketStartMsg,
  type RoomAdminSetMsg,
  type RoomInfoChangeMsg,
  type RoomSilentMsg,
  type RoomWarnMsg,
  type SuperChatMsg,
  type User,
  type UserActionMsg,
  type WatchedChangeMsg,
  startListen,
};
