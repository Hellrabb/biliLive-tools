import type { DanmuItem, SC, Gift, Guard, DanmakuFilterRule } from "@biliLive-tools/types";
...
export interface AutoClipResult {
  ...
  /** Rules auto-generated during this pipeline run (not yet persisted to preset) */
  autoGeneratedRules?: DanmakuFilterRule[];
  danmakuFilterStats?: {
    totalBefore: number;
    totalAfter: number;
    removed: number;
